...
<button class="pointer-events-auto flex items-center justify-center h-[20px] w-[20px] relative rounded-full bg-[var(--bg-inverse)]" aria-label="Cart Summary" transition:fly="{{ y: 200, duration: 1000 }}" on:click={() => { $storage.cartOpen = !$storage.cartOpen; }}>
